...
class TestCodeSampleGenerator:
    ...
    def test_generate_typescript_sample(self):
        ...
        generator = CodeSampleGenerator(
            code_sample_languages=[CodeLanguage.TYPESCRIPT]
        )
    ...
    def test_generate_go_sample(self):
        ...
        generator = CodeSampleGenerator(
            code_sample_languages=[CodeLanguage.GO]
        )
    ...
    def test_generate_java_sample(self):
        ...
        generator = CodeSampleGenerator(
            code_sample_languages=[CodeLanguage.JAVA]
        )
    ...
    def test_generate_php_sample(self):
        ...
        generator = CodeSampleGenerator(
            code_sample_languages=[CodeLanguage.PHP]
        )
    ...
    def test_generate_ruby_sample(self):
        ...
        generator = CodeSampleGenerator(
            code_sample_languages=[CodeLanguage.RUBY]
        )
    ...
    def test_generate_csharp_sample(self):
        ...
        generator = CodeSampleGenerator(
            code_sample_languages=[CodeLanguage.CSHARP]
        )
    ...
    def test_error_handling_invalid_endpoint(self):
        ...
        with pytest.raises(ValueError):
            EndpointDocumentation(
                path='',  # Empty path should raise ValueError
                method=HTTPMethod.GET,
                summary='Invalid'
            )
        ...
        with pytest.raises(TypeError):
            EndpointDocumentation(
                path='/api/test',
                method='INVALID',  # Invalid method should raise TypeError
                summary='Test'
            )
